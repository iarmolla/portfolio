...
function Home() {
  return (
    <main >
      {/* <section className='text-center flex flex-col gap-3 justify-center items-center mt-8 xl:m-0 one'>       
      ...
      <section className='flex justify-center gap-8 cursor-pointer text-gray-600 py-6 text-3xl two'>
      ...
      <section className='flex flex-col justify-center items-center gap-4 four' id="projects">
      ...
      <section className='text-center flex flex-col gap-3 justify-center items-center xl:m-0 one'>
        <article className='w-full xl:h-screen  flex flex-col justify-center items-center justify-items-center'>
          <h1 className='text-slate-700 title text-5xl xl:text-9xl'>Iván Armolla</h1>
          <h2 className='text-4xl text-slate-800 xl:text-7xl'>Front-end Developer.</h2>
          <div className='hidden xl:block xl:text-5xl xl:mt-16 xl:text-slate-600 xl:cursor-pointer xl:animate-bounce xl:hover:text-slate-500 xl:transition-all'>
      ...
      <section className='text-center flex flex-col gap-3 justify-center items-center xl:m-0 two'>
      ...
      <section className='text-center flex flex-col gap-3 justify-center items-center xl:m-0 three' id="skills">
        <div className='flex flex-col justify-center items-center justify-items-center pb-20'>
          <h4 className='link-project text-slate-500 text-2xl text-center rounded-sm uppercase p-2 mb-16 mt-28'>
            <span></span>
            <span></span>
            <span></span>
            <span></span>
      ...
      <section className='text-center flex flex-col gap-3 justify-center items-center xl:m-0 pb-32 four' >
        <section className='flex flex-col justify-center items-center gap-4 pb-24' id="projects">
          <h4 className='link-project text-slate-500 text-2xl text-center rounded-sm uppercase p-2 mt-20' >
            <span></span>
            <span></span>
            <span></span>
            <span></span>proyectos</h4>
